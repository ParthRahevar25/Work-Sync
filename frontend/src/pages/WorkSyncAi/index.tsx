                      ...
                      {[
                        {
                          ...
                          label: "Designation",
                          value: msg.profile.designation,
                        },
                        {
                          icon: <Users size={11} />,
                          label: "Department",
                          value: msg.profile.department,
                        },
                        {
                          icon: <MapPin size={11} />,
                          label: "Location",
                          value: msg.profile.workLocation,
                        },
                        {
                          icon: <Calendar size={11} />,
                          label: "Joined",
                          value: msg.profile.joiningDate,
                        },
                        {
                          icon: <User size={11} />,
                          label: "Manager",
                          value: msg.profile.manager,
                        },
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 space-y-2">
                    ...
                    <div className="p-3 bg-white/5 rounded-xl border border-white/5 space-y-2">
                      {[
                        {
                          label: "Code",
                          value: msg.employeeProfile.employeeCode,
                        },
                        {
                          label: "Designation",
                          value: msg.employeeProfile.designation,
                        },
                        {
                          label: "Department",
                          value: msg.employeeProfile.department,
                        },
                        {
                          label: "Location",
                          value: msg.employeeProfile.workLocation,
                        },
                        { label: "Status", value: msg.employeeProfile.status },
                        {
                          label: "Joined",
                          value: msg.employeeProfile.joiningDate,
                        },
                        {
                          label: "Manager",
                          value: msg.employeeProfile.manager,
                        },
                      ...
                      {msg.employeeProfile.leaveBalance && (
                        <div className="pt-2 mt-1 border-t border-white/5 grid grid-cols-3 gap-2">
                          <BalanceItem
                            label="Casual"
                            value={msg.employeeProfile.leaveBalance.casual}
                            color="blue"
                          />
                          <BalanceItem
                            label="Sick"
                            value={msg.employeeProfile.leaveBalance.sick}
                            color="emerald"
                          />
                          <BalanceItem
                            label="Paid"
                            value={msg.employeeProfile.leaveBalance.paid}
                            color="amber"
                          />
                        </div>
                      )}
